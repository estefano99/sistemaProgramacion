...
?>
    ...
    <section class="container">
        ...
        ?>
                ...
                <tbody>
                <?php
                    foreach ($listaTipoDeTragos as $tragos) {
                ?>
                    <tr>
                        <td>
                            <?php echo $tragos["nombre"]; ?>
                            <input type="hidden" name="txtID" id="txtID" value="<?php echo $tragos['id_tipodetragos'];?>">
                        </td> 
                        <td>
                            <a href="modificarTipoDeTragos.php?upd=<?php echo $tragos["id_tipodetragos"]?>">
                            ...
                            <a href="eliminarTipoDeTragos.php?url=<?php echo $tragos["id_tipodetragos"]?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 iconos">
